...
namespace OpenWifi {
	...
	static ORM::FieldVec Boards_Fields{ORM::Field{"timestamp", ORM::FieldType::FT_BIGINT},
	...
	static ORM::IndexVec BoardsDB_Indexes{
		{std::string("stationid_name_index"),
		 ORM::IndexEntryVec{{std::string("station_id"), ORM::Indextype::ASC}}},
		{std::string("station_ven_ts_id_name_index"),
		 ORM::IndexEntryVec{{std::string("venue_id"), ORM::Indextype::ASC},
							{std::string("station_id"), ORM::Indextype::ASC},
							{std::string("timestamp"), ORM::Indextype::ASC}}}};

	WifiClientHistoryDB::WifiClientHistoryDB(OpenWifi::DBType T, Poco::Data::SessionPool &P,
											 Poco::Logger &L)
	...
	bool
	WifiClientHistoryDB::GetClientMacs(std::vector<std::pair<std::string, std::string>> &Macs) {
		try {
			...
			Select << St, Poco::Data::Keywords::into(RecordList);
			Select.execute();
...
template <>
void ORM::DB<OpenWifi::WifiClientHistoryDBRecordType,
			 OpenWifi::AnalyticsObjects::WifiClientHistory>::
	Convert(const OpenWifi::WifiClientHistoryDBRecordType &In,
			OpenWifi::AnalyticsObjects::WifiClientHistory &Out) {
...
void ORM::DB<OpenWifi::WifiClientHistoryDBRecordType,
			 OpenWifi::AnalyticsObjects::WifiClientHistory>::
	Convert(const OpenWifi::AnalyticsObjects::WifiClientHistory &In,
			OpenWifi::WifiClientHistoryDBRecordType &Out) {
